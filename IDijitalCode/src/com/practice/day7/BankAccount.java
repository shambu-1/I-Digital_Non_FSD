...
public class BankAccount {
	...
	public Long deposit(Long amount) {
		...
		System.out.println("The amount has been credited to account number" + accountNumber + "\nThe balance amount is ");
		return balance;
	}
	
	public Long withdrawal(Long amount) {
		balance = balance - amount;
		System.out.println("The amount has been debited from account number " + accountNumber + "\nThe balance amount is ");
		return balance;
	}
